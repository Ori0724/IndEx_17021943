...
# Step 3: Create the user, forecast and city tables
c.execute('''
        CREATE TABLE user
...
# Insert data
# Insert data for a user using values from variable
...
# Insert data for a city using values from variable
...
# Insert forecast for the user about the city
...
# Step 5: Save (commit) the changes using connection.commit()
conn.commit()
